...
tape.skip('[LightFourtwentyService]', (t) => {
  ...
  const { LightFourtwentyService } = require('../../lib/service')

  t.test('should initialize correctly', async (t) => {
    const service = new LightFourtwentyService()
  ...
  t.test('should open', async (t) => {
    ...
    const service = new LightFourtwentyService({ servers: [server] })
    await service.open()
