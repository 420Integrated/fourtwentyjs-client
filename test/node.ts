...
tape('[Node]', (t) => {
  class FourtwentyService extends EventEmitter {}
  FourtwentyService.prototype.open = td.func()
  FourtwentyService.prototype.start = td.func()
  FourtwentyService.prototype.stop = td.func()
  td.when(FourtwentyService.prototype.open()).thenResolve()
  td.when(FourtwentyService.prototype.start()).thenResolve()
  td.when(FourtwentyService.prototype.stop()).thenResolve()
  td.replace('../lib/service', { FourtwentyService })
  ...
  t.test('should initialize correctly', (t) => {
    const node = new Node()
    t.ok(node.services[0] instanceof FourtwentyService, 'added service')
    t.end()
  })
