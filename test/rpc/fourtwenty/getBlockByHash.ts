...
const method = 'fourtwenty_getBlockByHash'
...
tape('call fourtwenty_getBlockByHash without second parameter', (t) => {
  const server = baseSetup()
...
tape('call fourtwenty_getBlockByHash with invalid second parameter', (t) => {
  const server = baseSetup()
