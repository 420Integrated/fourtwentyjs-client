import { FourtwentyService } from '../../service/fourtwentyservice'
import { middleware } from '../validation'
import { addHexPrefix } from 'fourtwentyjs-util'
...
export class Net {
  ...
  constructor(node: any) {
    const service: FourtwentyService = node.services.find((s: any) => s.name === 'fourtwenty')
