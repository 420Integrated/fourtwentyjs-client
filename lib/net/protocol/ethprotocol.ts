...
import { BN, bufferToInt } from 'fourtwentyjs-util'
import { BlockHeader, BlockHeaderBuffer } from '@fourtwentyjs/block'
 ...
 */
export class FourtwentyProtocol extends Protocol {
  private chain: Chain
